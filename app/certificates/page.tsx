...
export default function CertificatesPage() {
  ...
  <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white px-4 z-10">
    ...
    <p className="max-w-2xl text-sm md:text-base text-gray-200">
      نوفر لك خدمة استخراج الشهادات الرسمية بأسلوب قانوني موثوق،
      مع متابعة كاملة حتى التسليم
    </p>
    ...
    <div className="grid lg:grid-cols-2 gap-12 items-center">
      ...
      <div>
        ...
        <p className="mt-5 text-lg leading-8 text-[#27215f]/70">
          نوفر لك خدمة استخراج الشهادات الرسمية من الجهات المعتمدة
          بأسلوب قانوني موثوق وسريع، مع متابعة كاملة لكل الإجراءات
          حتى استلام الشهادة.
        </p>
...
badge={
  ...
  description={
    <span className="text-[#27215f]/70">
      ...
      مع تصديقها من الجهات المختصة لتكون جاهزة للاستخدام محلياً ودولياً.
    </span>
  }
